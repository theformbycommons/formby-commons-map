...
export const metadata = {
  title: 'About The Formby Commons',
  description: 'The idea and vision behind The Formby Commons project.',
};
    ...
    <div className="max-w-3xl mx-auto space-y-8">
      <Card className="shadow-lg">
        <CardHeader className="text-center border-b pb-6">
          ...
          <CardTitle className="font-headline text-4xl text-primary">The Idea Behind The Formby Commons</CardTitle>
        </CardHeader>
        <CardContent className="pt-8 px-6 md:px-8 space-y-6 text-foreground/90 leading-relaxed">
          <section aria-labelledby="section-introduction">
            ...
            <p className="mb-4">
     The Formby Commons provides a constructive online space where communities can share their ideas, and turn visions into real local change. We believe that the most meaningful improvements often start at the grassroots level – with the people who know their local areas best and are driven to make them better.</p>
   <p>Our communities aren't fixed; they're living, changing spaces shaped by the people who live in them. While top-down solutions often miss the mark, The Formby Commons champions a more direct, democratic approach, empowering citizens to explore community support.</p>
          ...
          <section aria-labelledby="section-from-ideas-to-impact">
            ...
            <p className="mb-4">
 The Formby Commons builds on the foundation of celebrating local connections, much like our sister site, The Formby Commons (theformbycommons.github.io). While The Formby Commons highlights the valued aspects of our towns, The Formby Commons takes things in a slightly different direction: it's a space for action. This platform invites you to turn insights into initiatives, providing a public forum to share and gather support for projects that aim to improve our shared spaces and collective well-being.
            </p>
 <p>
 Whether it's a proposal for a new community garden, a plan to revitalize a neglected public space, or an idea for making key community spots easier to reach on foot or by bike, The Formby Commons helps these ideas gain traction. Users can describe their proposed projects and, importantly, gather public votes of support. 
            </p>
...
This public endorsement provides a clear measure of community backing, which can be a powerful tool for those considering formal petitions, seeking local government engagement, or directly launching projects. This approach aligns with the idea of local engagement, where community members actively shape their environment, rather than passively receiving change (Irvin & Stansbury, 2004).
 ...
 Furthermore, The Formby Commons seeks to bridge divides across different groups and viewpoints. By focusing on concrete, local improvements, the platform encourages collaborative thinking and helping to build a sense of shared purpose, moving beyond potential differences. It's about finding common ground in the desire for a better hometown, fostering a sense of shared ownership and responsibility for the local space and environment.
          ...
          <section aria-labelledby="section-catalyst-for-democratic-innovation">
            ...
            <p className="mb-4">
 This project demonstrates how digital tools can facilitate democratic innovation at the local level. While not replacing traditional forms of civic engagement, The Formby Commons complements them by providing an accessible, transparent, and user-friendly space for brainstorming and mobilization. It aligns with growing research on digital democracy and how online platforms can boost citizen participation and influence local governance (Smith, 2009).
            </p>
            <p>
 Born from the same passion for place and community, The Formby Commons is a non-profit endeavour. It is free from advertising and commercial interests, driven solely by the desire to empower communities and facilitate positive change from the ground up. We believe that by providing a platform where local ideas can gain collective momentum, we can help create more responsive and democratic local communities.
            </p>
          </section>
