    ...
    <div className="max-w-3xl mx-auto space-y-8">
      <Card className="shadow-lg" data-testid="terms-conditions-card">
        ...
        <CardContent className="pt-8 px-6 md:px-8 space-y-6 text-foreground/90 leading-relaxed">
          <p>
            These terms and conditions (the "Terms and Conditions") govern the use of localglow.uk (the "Site"). This Site is owned and operated by Felix Zajitschek (“owner of localglow.uk”). This Site is a not-for-profit community project that lets users submit and view descriptions and pictures/photos of locations in the UK.
          </p>
          <p>
